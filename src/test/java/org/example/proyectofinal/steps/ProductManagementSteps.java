package org.example.proyectofinal.steps;
            ...
            public class ProductManagementSteps {
                ...
                @Given("I have created a product with name {string} and price {double}")
                public void i_have_created_a_product_with_name_and_price(String productName, Double price) {
                    i_create_a_product_with_name_and_price(productName, price);
                    assertTrue(response.getStatusCode().is2xxSuccessful(), "Failed to create product for test setup");
                }

                @Given("I have created a product with name {string} and price {double} and category {string}")
                public void i_have_created_a_product_with_name_price_and_category(String productName, Double price, String category) {
                    try {
                        Producto producto = new Producto();
                        producto.setNombre(productName);
                        producto.setPrecio(price);
                ...
                @Given("I have created a product as admin with name {string} and price {double}")
                public void i_have_created_a_product_as_admin(String productName, Double price) {
                ...
                public void there_are_existing_products_in_the_system() {
                    // Create a test product to ensure there's at least one
                    i_have_created_a_product_with_name_and_price("Test Product for List", 99.99);
                }
                ...
                public void i_update_the_product_name_and_price(String newName, Double newPrice) {
                    try {
                        Producto updatedProduct = new Producto();
                        updatedProduct.setId(createdProductId);
                        updatedProduct.setNombre(newName);
                        updatedProduct.setPrecio(newPrice);
                ...
                @When("I update the product as employee with name {string} and price {double}")
                public void i_update_the_product_as_employee(String newName, Double newPrice) {
                    i_update_the_product_name_and_price(newName, newPrice);
                }
                ...
                @When("I attempt to create a product with empty name {string} and price {double}")
                public void i_attempt_to_create_a_product_with_empty_name_and_price(String productName, Double price) {
                    i_create_a_product_with_name_and_price(productName, price);
                }
